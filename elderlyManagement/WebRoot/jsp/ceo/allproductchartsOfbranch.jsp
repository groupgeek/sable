...
<html>
  ...
  <body>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break">&nbsp;&nbsp;<span id="branchName"></span>总商品报表</span></h2>	
						<div class="box-icon">
					...
					<div class="box-content">
						...
						<div style="width:100%;height:400px;margin-bottom: 100px;">
							<div id = "productchartofbranch" style="padding:5px;width:69%;height:100%;float:left"></div>
							<div id="chart1" style="padding:5px;width:29%;height:100%;float:left;"></div>
						</div>
						<div style="width:100%;height:400px;">
							<div id = "productchartofbranchLine" style="padding:5px;width:69%;height:100%;float:left;"></div>
	...
	<!-- start: JavaScript-->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/jsp/ceo/newjs/allproductchartsOfbranch.js"></script>
	<!-- end: JavaScript-->
  </body>
</html>
