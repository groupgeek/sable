...
<html>
  ...
  <body>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break">&nbsp;&nbsp;总活动报表</span></h2>	
						<div class="box-icon">
	...
	<!-- start: JavaScript-->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/jsp/ceo/newjs/activityChart.js"></script>
	<!-- end: JavaScript-->
  </body>
</html>
