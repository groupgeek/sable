			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon white align-justify"></i><span class="break"></span>用户信息</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  <tbody>
								<tr>
									<td>姓名</td>
									<td class="center">${findUserById.username}</td>
									                                    
								</tr>
								<tr>
									<td>性别</td>
									<td class="center">${findUserById.sex }</td>
