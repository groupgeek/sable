$(document).ready(function(){
	...
	$.ajax({		
		...
		url:root+"/ceo/userindex",
		data:'{}',
		success:function(data){			
			if(data[0].avatar == null){
				$("#avatar1 img").html(data[0].avatar);
			}else{
				$("#avatar1 img").attr("src","http://com-xiaohe-res.oss-cn-beijing.aliyuncs.com/"+data[0].avatar);
			}
			if(data[1].avatar == null){
				$("#avatar2 img").html(data[1].avatar);
			}else{
				$("#avatar2 img").attr("src","http://com-xiaohe-res.oss-cn-beijing.aliyuncs.com/"+data[1].avatar);
			}
			if(data[2].avatar == null){
				$("#avatar3 img").html(data[2].avatar);
			}else{
				$("#avatar3 img").attr("src","http://com-xiaohe-res.oss-cn-beijing.aliyuncs.com/"+data[2].avatar);
			}
			if(data[3].avatar == null){
				$("#avatar4 img").html(data[3].avatar);
			}else{
				$("#avatar4 img").attr("src","http://com-xiaohe-res.oss-cn-beijing.aliyuncs.com/"+data[3].avatar);
			}
		}		
	});
