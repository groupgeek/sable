			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon white align-justify"></i><span class="break"></span>商品信息</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  <tbody>
								<tr>
									<td>商品名称</td>
									<td class="center">${findProductById.productname}</td>
									                                    
								</tr>
								<tr>
									<td>销量</td>
									<td class="center">${findProductById.buyno }</td>
