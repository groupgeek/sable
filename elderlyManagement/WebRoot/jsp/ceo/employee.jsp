			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon white align-justify"></i><span class="break"></span>员工详情</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  <tbody>
								<tr>
									<td>姓名</td>
									<td class="center">${findEmployeeAllMessage.employeename }</td>
									                                    
								</tr>
								<tr>
									<td>性别</td>
									<td class="center">${findEmployeeAllMessage.sex }</td>
									                                      
								</tr>
								<tr>
									<td>出生日期</td>
									<td class="center">${findEmployeeAllMessage.birthday }</td>
									                                        
								</tr>
								<tr>
									<td>家庭地址</td>
									<td class="center">${findEmployeeAllMessage.address }</td>
									                                       
								</tr>
								<tr>
									<td>手机号码</td>
									<td class="center">${findEmployeeAllMessage.phone }</td>
									                                        
								</tr> 
								<tr>
									<td>员工账号</td>
									<td class="center">${findEmployeeAllMessage.accountnumber }</td>                                        
								</tr>  
								<tr>
									<td>邮箱地址</td>
									<td class="center">${findEmployeeAllMessage.email }</td>                                        
								</tr>
								<tr>
									<td>所在分店</td>
									<td class="center">${findEmployeeAllMessage.branchname }</td>                                        
								</tr>   
								<tr>
									<td>入职时间</td>
									<td class="center">${findEmployeeAllMessage.entrytime }</td>                                        
								</tr>
								<tr>
									<td>身份权限</td>
									<td class="center">${findEmployeeAllMessage.authoritylevel }</td>                                        
								</tr> 
								<tr>
									<td>职位</td>
									<td class="center">${findEmployeeAllMessage.positionname }</td>                                        
								</tr>
								<tr>
									<td>工资</td>
									<td class="center">${findEmployeeAllMessage.wage }</td>                                        
								</tr>
								<tr>
									<td>银行卡号</td>
									<td class="center">${findEmployeeAllMessage.bankcardno }</td>                                        
								</tr>   
								<tr>
									<td>奖金</td>
									<td class="center">${findEmployeeAllMessage.totalbonus }</td>                                        
								</tr>                          
							  </tbody>
						 </table>  
