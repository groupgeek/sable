			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li id="userInfo"><a href="${pageContext.request.contextPath }/Commonsense/insert">
						<i class="icon-bar-chart"></i><span class="hidden-tablet">添加信息</span>
						</a>
						</li>
					</ul>
				</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath }/Commonsense/update" method="post">  
							<fieldset>
							<input type="hidden"name=commonsenseid value="${commonsenseid}">
							  <div class="control-group" id="title">
								<label class="control-label" for="focusedInput">标题</label>
								<div class="controls">
								  <input class="input-xlarge focused" name = "title" type="text" value="${commonsense.title}">
								</div>
							  </div>
							  ...
							  <div class="control-group" id = "contexttype">
								<label class="control-label">文章种类</label>
								<div class="controls">
								 <input class="input-xlarge focused" type="text" name="contexttype" value="${commonsense.contexttype} " >
								</div>
							  </div>
							  <div class="control-group hidden-phone" id = "context">
								  <label class="control-label">内容</label>
								  <div class="controls">
									<div id="div1" style="width: 80%"></div>
									 <input type="text" id = "textData" name = "context" value="${commonsense.context} ">
								  </div>
							  </div>
