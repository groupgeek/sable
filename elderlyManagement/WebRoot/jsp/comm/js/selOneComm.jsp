						...
						<form class="form-horizontal"  method="post">  
							<fieldset>
							  ...
							  <div class="control-group" id="title">
								...
								<div class="controls">
								  <input class="input-xlarge focused"   readonly="true" name = "title" type="text" value="${commonsense.title}">
								</div>
							  </div>
							  ...
							  <div class="control-group" id = "contexttype">
								...
								<div class="controls">
								 <input class="input-xlarge focused"  readonly="true" type="text" name="contexttype" value="${commonsense.contexttype} " >
								</div>
							  </div>
							  <div class="control-group hidden-phone" id = "context">
								  <label class="control-label">内容</label>
								  <div class="controls">
									 <input type="text" id = "textData"  readonly="true"  name = "context" value="${commonsense.context} ">
								  </div>
							  </div>
