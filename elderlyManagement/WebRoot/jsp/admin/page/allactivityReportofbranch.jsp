				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white user"></i><span class="break">&nbsp;&nbsp;<span id="branchName"></span>总活动报表</span>
							</h2>
							<!-- <h2>
...
<%-- 	<script src="${pageContext.request.contextPath }/jsp/js/jquery.js"></script> --%>
	...
	<script src="${pageContext.request.contextPath }/jsp/admin/page/js/allactivityReportofbranch.js"></script>
