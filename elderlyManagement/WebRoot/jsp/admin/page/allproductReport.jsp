	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${pageContext.request.contextPath }/jsp/admin/page/allproductReport.jsp">总商品报表管理</a>
				</li>
			</ul>
...
<%-- 	<script src="${pageContext.request.contextPath }/jsp/js/jquery.js"></script> --%>
	...
	<script src="${pageContext.request.contextPath }/jsp/admin/page/js/allproductReport.js"></script>
