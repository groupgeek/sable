...
<link id="superAdmin"
	href="${pageContext.request.contextPath }/jsp/admin/page/css/mallRebhcrt.css"
	rel="stylesheet">
<!-- end: CSS -->
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white user"></i><span class="break"></span>报表信息管理
							</h2>
							<!-- <h2>
						...
						<div class="box-content " id="box">
							<div>
								...
								<button id="activitys" class="btn btn-success">查看总活动报表</button>
								<button id="products" class="btn btn-success">查看总商品报表</button>
								<!-- <select id="allBranch">
									<option value= -1 selected="selected">全部分店</option>
								</select>  -->								
...
<%-- 	<script src="${pageContext.request.contextPath }/jsp/js/jquery.js"></script> --%>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/jsp/admin/page/js/mallRebhcrt.js"></script>
