...
<link id="superAdmin"
	href="${pageContext.request.contextPath }/jsp/admin/page/css/mallReact.css"
	rel="stylesheet">
<!-- end: CSS -->
	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${pageContext.request.contextPath }/jsp/admin/page/mallReact.jsp">活动报表管理</a>
				</li>
			</ul>
...
<%-- 	<script src="${pageContext.request.contextPath }/jsp/js/jquery.js"></script> --%>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/jsp/admin/page/js/mallReact.js"></script>
