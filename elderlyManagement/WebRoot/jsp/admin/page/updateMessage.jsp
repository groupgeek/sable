...
<input id="root" type="hidden"
	...
	<!-- start: Header --><div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >企业网站模板</a></div>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">留言信息修改</a></li>
			</ul>
			
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>留言信息修改</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal" action = "${pageContext.request.contextPath }/superAdmin/" method="post">
							<fieldset>
							   ...
							   <div class="control-group" id = "messagetime">
								...
								<div class="controls">
								  	<input class="input-xlarge focused" name = "messagetime" type="text" onClick="laydate()" value="">
								</div>
							  </div>
							  ...
							  <div class="control-group hidden-phone" id = "messagecontext">
								  ...
								  <div class="controls">
									<textarea class="" id="" rows="6"  name="messagecontext" style="width: 500px;"></textarea>
								  </div>
							  </div>
							 ...
							 <input type="hidden" value="" id = "userid" name = "userid">
							  ...
							  <div class="form-actions">
								<button type="button" id = "updateMessage" class="btn btn-primary">保存</button>
							  </div>
							</fieldset>
						  </form>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/jsp/admin/page/js/updateMessage.js"></script>
