	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${pageContext.request.contextPath }/jsp/admin/page/mallReport.jsp">商城报表管理</a>
					<i class="icon-angle-right"></i>
				</li>
				<li>
					<a href="#">商品报表管理</a>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white user"></i><span class="break"></span>商品报表
							</h2>
							<!-- <h2>
							...
							<div class="box-icon">
								<a href="${pageContext.request.contextPath }/jsp/admin/page/mallReport.jsp" ><i class="halflings-icon white remove"></i></a>
							</div>
						</div>
...
<%-- 	<script src="${pageContext.request.contextPath }/jsp/js/jquery.js"></script> --%>
	...
	<script src="${pageContext.request.contextPath }/jsp/admin/page/js/oneproductReport.js"></script>
