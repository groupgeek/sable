...
<body>
	...
	<jsp:include page="menu.jsp"></jsp:include>
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${pageContext.request.contextPath }/productmanage/quertyProduct.action">商品信息</a> 	
					<i class="icon-angle-right"></i>
				</li>
				<li><a>商品详细信息</a></li>
			</ul>
							...
							<div style="padding-bottom: 30px">
								<div id="header">
									...
									<div id="section">
										<div class="control-group">
											...
											<div class="controls">
								  				<input class="input-xlarge disabled" id="disabledInput" type="text" name="productname" value="${list.productname }" disabled="">
											</div>
							  			</div>
							   			<div class="control-group">
							 				<label class="control-label" for="typeahead">商品存货 </label>
							  				<div class="controls">
							   					<input class="input-xlarge disabled" id="disabledInput" type="text" name="instock" value="${list.instock }" disabled="">
							  				</div>
							  			</div>
							 			 <div class="control-group">
											<label class="control-label" for="optionsCheckbox2">商品单价</label>
											<div class="controls">
							   					<input class="input-xlarge disabled" id="disabledInput" type="text" name="price" value="$/upload/${list.price }" disabled="">
							  				</div>
							  			</div>
							  			<div class="control-group">
											<label class="control-label" for="disabledInput">成交量</label>
											<div class="controls">
								  				<input class="input-xlarge disabled" id="disabledInput" type="text" name="buyno" value="${list.buyno }" disabled="">
											</div>
							  			</div>
							  			<div class="control-group">
											<label class="control-label" for="disabledInput">商品进价</label>
											<div class="controls">
								  				<input class="input-xlarge disabled" id="disabledInput" type="text" name="purchaseprice" value="${list.purchaseprice }" disabled="">
											</div>
							  			</div>
							  			<div class="control-group">
											<label class="control-label" for="disabledInput">好评量</label>
											<div class="controls">
								  				<input class="input-xlarge disabled" id="disabledInput" type="text" name="good" value="${list.good }" disabled="">
											</div>
							  			</div>
							  			<div class="control-group">
											<label class="control-label" for="disabledInput">保质期</label>
											<div class="controls">
								  				<input class="input-xlarge disabled" id="disabledInput" type="text" name="shelflife" value="${list.shelflife }" disabled="">
											</div>
							  			</div>
									</div>
								...
								<div id="nav">
									<div class="control-group">
										...
										<div class="controls">
							   				<input class="input-xlarge disabled" id="disabledInput" type="text" name="producstandards" value="${list.producstandards }" disabled="">
							  			</div>
							  		</div>
							  		<div class="control-group">
										<label class="control-label">产品规格</label>
										<div class="controls">
							   				<input class="input-xlarge disabled" id="disabledInput" type="text" name="productspecifications" value="${list.productspecifications }" disabled="">
							  			</div>
							  		</div>							  		
								</div>
								<div id="section">
									<div class="control-group">
										...
										<div class="controls">
							   				<input class="input-xlarge disabled" id="disabledInput" type="text" name="productionlicensenumber" value="${list.productionlicensenumber }" disabled="">
							  			</div>
							  		</div>					  
								</div>
								</div>
								<div id="footer">
									<div class="control-group">
										...
										<div class="controls">
							   				<input class="message" id="disabledInput" type="text" name="description" value="${list.description }" disabled="">
							  			</div>
							  		</div>
							  		<div class="control-group">
										<label class="control-label" for="disabledInput">存储方式</label>
										<div class="controls">
							   				<input class="message" id="disabledInput" type="text" name="storagemethod" value="${list.storagemethod }" disabled="">
							  			</div>
							  		</div>
							  		<div class="control-group">
										<label class="control-label" for="disabledInput">食用方法</label>
										<div class="controls">
							   				<input class="message" id="disabledInput" type="text" name="ediblemethod" value="${list.ediblemethod }" disabled="">
							  			</div>
							  		</div>
								</div>
							</fieldset>
