			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="${pageContext.request.contextPath }/brach/branchTran.action"><i class="icon-thumbs-up"></i><span class="hidden-tablet"> 
						推荐商品</span></a></li>
						...
						<li><a href="${pageContext.request.contextPath }/brach/allActs.action"><i class="icon-briefcase"></i><span class="hidden-tablet">本店推荐</span></a></li>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<c:forEach items="${recommendproduct }" var="rpdt">
					<tr>
						<td class="center">${rpdt.productname }</td>
						...
						<td class="center">${rpdt.producttypename}</td>
						<td class="center"> ${rpdt.price}</td>
						<td class="center">${rpdt.instock}</td>
						<td class="center">
						<a class="btn btn-success" href="${pageContext.request.contextPath }/productmanage/productInfo.action?productid=${rpdt.productid}">
										<i class="halflings-icon white zoom-in"></i>
									</a>
									<a class="btn btn-info" href="${pageContext.request.contextPath }/productmanage/selectProduct.action?productid=${rpdt.productid}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="${pageContext.request.contextPath }/productmanage/deleteproduct.action?productid=${rpdt.productid}">+
