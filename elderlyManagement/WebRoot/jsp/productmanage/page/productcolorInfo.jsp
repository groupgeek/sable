			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<tr>
						...
						<td class="center"> ${Color.sizestock}</td>
						...
						<!-- <a class="btn btn-success" href="#">
									...
									<a class="btn btn-info" href="${pageContext.request.contextPath }/productmanage/selectProduct.action?productid=${Color.productid}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="${pageContext.request.contextPath }/productmanage/deleteproduct.action?productid=${Color.productid}">+
