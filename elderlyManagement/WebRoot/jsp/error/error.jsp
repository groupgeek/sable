	...
	<div class="controller">
		<div class="objects">
			...
			<div class="text-area rotate">
				...
				<p class="details" style="font-size: 1.2em;">
					服务器开小差了<br />
					<br />您可以检查一下网络或者电话联系我们,了解原因 
				</p>
			</div>
			<!-- home page -->
			<div class="homepage rotate" style="font-size: 1.7em;">
				<a href="${pageContext.request.contextPath }/branch/index">返回官网</a>
			</div>
			<!-- home page -->
		</div>
	</div>
