					...
					<div id="pageNumBox">
						...
						<table class="table table-striped table-bordered bootstrap-datatable " >
						 ...
						 <tr>
							   ...
							   <td>${productCustom2.countPrice }</td>
							   <td>${productCustom2.countBuy }</td>
						 </tr>
	...
	<script type="text/javascript">
		...
		function productReport() {
			...
			for(var i in data.List){
				$("#ddd tbody").append(
							'<tr>'+
							'<td class="center">'+(data.list)[i].productname+'</td>'+
							'<td class="center">'+(data.list)[i].buy+'</td>'+
							'<td class="center">'+(data.list)[i].countbuy+'</td>'+
							'<td class="center">'+(data.list)[i].totalprice+'</td>'+
							'</tr>'
							);
					}
		}
