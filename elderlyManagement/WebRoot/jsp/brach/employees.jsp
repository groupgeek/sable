	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>员工信息</h2>
						<div class="box-icon">
			...
			<a class="btn btn-primary" href="${pageContext.request.contextPath }/brach/insert.action"><i class=" icon-plus-sign"></i>  添加新员工</a>
						...
						<td class="center">
						<fmt:formatDate value="${employees.entrytime }" pattern="yyyy-MM-dd"/>
						</td>
						<td class="center">${employees.email }</td>
						<td class="center">
									<a class="btn btn-info" href="${pageContext.request.contextPath }/brach/oneEmp.action?id=${ employees.employeeid}">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="${pageContext.request.contextPath }/brach/delEmpl.action?id=${ employees.employeeid}">
