		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="control-group" id="control-group">
							  ...
							  <div class="controls">
								...
								至：<input name="activitydate" type="text" onClick="laydate()" id="end">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
									<input class="btn btn-info" onclick="allActReport()" style="margin-top: -10px" value="查询">       
							  </div>
					</div>
					...
					<!--  style="width: 700px;height: 400px;"   class 用来css定位 id是用来给js定位的-->
					
					<div class = "pieChart" id="pieChart">
					<div class="Actpie1" id="Actpie1"></div>
					<div class="Actpie2" id="Actpie2"></div>
					<div class="Actpie3" id="Actpie3"></div>
					</div>
					</div>
				</div><!--/span-->
