		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="control-group" id="control-group">
							  ...
							  <div class="controls">
								...
								至：<input name="activitydate" type="text" onClick="laydate()" id="end">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
									<input class="btn btn-info" onclick="allChart()" style="margin-top: -10px" value="查询">       
							  </div>
					</div>
					...
					<div class = "Allpie" id="Allpie">
					<div class="Allpie1" id="Allpie1"></div>
					<div class="Allpie2" id="Allpie2"></div>
					<div class="Allpie3" id="Allpie3"></div>
					</div>
				</div><!--/span-->
