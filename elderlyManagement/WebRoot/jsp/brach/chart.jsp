					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						 ...
						 <c:forEach items="${products }" var="products">
							<tr>
								<td class="center">${products.productname }</td>
								<td class="center">${products.price }</td>
								<td class="center">${products.countBuy }</td>
								<td class="center">${products.countPrice }</td>
								<td class="center">
								<a class="btn btn-info" href="${pageContext.request.contextPath }/brach/oneProductChart.action?id=${ products.productid}">
