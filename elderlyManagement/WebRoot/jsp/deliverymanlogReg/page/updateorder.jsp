				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white edit"></i><span class="break"></span>修改订单信息
							</h2>
							<div class="box-icon">
						...
						<form action="${pageContext.request.contextPath }/selectorder/updateorderbyid.action" class="form-horizontal" method="post">
						
							
							<div class="box-content">
								<fieldset>
									<input type="hidden" name="orderid" value="${orderOne.orderid }" />
									<input type="hidden" name="userid" value="${orderOne.userid }" />
									<input type="hidden" name="branchid" value="${orderOne.branchid }" />
									<input type="hidden" name="productid" value="${orderOne.productid }" />
									
									<div class="control-group" id="productname">
										<label class="control-label">商品名称</label>
										<div class="controls">
											<input class="input-xlarge" type="text" id="grumble" name="productname" value="${orderOne.productname}" />
										</div>
									</div>
									...
									<div class="control-group" id="username">
										...
										<div class="controls">
											<input class="input-xlarge " type="text" class="warning" name="username" value="${orderOne.username}" />
										</div>
									</div>
									...
									<div class="control-group" id="productnumber">
										...
										<div class="controls">
											<input class="input-xlarge " name="productnumber" value="${orderOne.productnumber}" />
										</div>
									</div>
									...
									<div class="control-group" id="price">
										...
										<div class="controls">
											<input class="input-xlarge" name="price" value="${orderOne.price}" />
										</div>
									</div>
