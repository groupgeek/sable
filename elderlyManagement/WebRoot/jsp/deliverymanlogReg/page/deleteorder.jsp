				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white edit"></i><span class="break"></span>删除订单
							</h2>
							<div class="box-icon">
						...
						<form action="${pageContext.request.contextPath }/selectorder/deleteorderbyid.action" class="form-horizontal" method="post">
						
							
							<div class="box-content">
								<fieldset>
									<input type="hidden" name="orderid" value="${orderTow.orderid }" />
									<input type="hidden" name="userid" value="${orderTow.userid }" />
									<input type="hidden" name="branchid" value="${orderTow.branchid }" />
									<input type="hidden" name="productid" value="${orderTow.productid }" />
									
									<div class="control-group" id="productname">
										<label class="control-label">商品名称</label>
										<div class="controls">
											<input class="input-xlarge" type="text" id="grumble" name="productname" value="${orderTow.productname}" />
										</div>
									</div>
									...
									<div class="control-group" id="username">
										...
										<div class="controls">
											<input class="input-xlarge " type="text" class="warning" name="username" value="${orderTow.username}" />
										</div>
									</div>
									...
									<div class="control-group" id="resaddress">
										...
										<div class="controls">
											<input class="input-xlarge" name="resaddress" value="${orderTow.resaddress}" />
										</div>
									</div>

									<div class="control-group" id="productnumber">
										<label class="control-label">商品数量</label>
										<div class="controls">
											<input class="input-xlarge " name="productnumber" value="${orderTow.productnumber}" />
										</div>
									</div>
									...
									<div class="control-group" id="totalprice">
										...
										<div class="controls">
											<input class="input-xlarge" type="text" id="picture" name="totalprice" value="${orderTow.productnumber * orderTow.price}" />
										</div>
									</div>
									...
									<div class="control-group" id="price">
										...
										<div class="controls">
											<input class="input-xlarge" name="price" value="${orderTow.price}" />
										</div>
									</div>
									...
									<div class="control-group" id="ordertime">
										...
										<div class="controls">
											<input class="input-xlarge" name="ordertime" value="${orderTow.ordertime}" />
										</div>
									</div>
									...
									<div class="control-group" id="status">
										...
										<div class="controls">
											<input class="input-xlarge" name="status" value="${orderTow.status}" />
										</div>
									</div>
