	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				...
				<!-- Start Sign In Form -->
				<form id="register"
					action="${pageContext.request.contextPath }/deliverymanlogReg/register.action"
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="email" name="phone"
							digits=true minlength=11 maxlength=11 placeholder="工号"
					...
					<div class="form-group">
						<p>
							已经注册? <a
								href="${pageContext.request.contextPath }/jsp/deliverymanlogReg/login.jsp">登录</a>
						</p>
					</div>
					<div class="form-group">
						<center><input type="submit" value="注册" class="btn btn-primary"></center>
					</div>
				</form>
				<!-- END Sign In Form -->
