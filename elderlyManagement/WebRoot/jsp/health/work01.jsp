...
<html lang="en">
  <head>
    ...
    <script src="${pageContext.request.contextPath }/jsp/health/assets/js/hover.zoom.conf.js"></script>
  ...
  <body>
	...
	<div class="container pt">
		...
		<div class="row mt centered">	
			...
			<%-- 	<p><img class="img-responsive" src="/upload/${ac.activitypicture}" ></p> --%>
				<p><img class="img-responsive" src="${pageContext.request.contextPath }/jsp/health/assets/img/portfolio/2.jpg" alt=""></p>
				<p><img class="img-responsive" src="${pageContext.request.contextPath }/jsp/health/assets/img/portfolio/3.jpg" alt=""></p>
