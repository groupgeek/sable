					...
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								...
								<div class="price">已经报名人数：${a }</div>
								<div class="price">最大报名人数：${act.maxnum }</div>
								<c:if test="${activityregistery.registery == '报名' }">
								<div class="well" style="width: 300px"><label>已报名</label></div>
								</c:if>
								<c:if test="${activityregistery.registery != '报名' }">
								<div class="well" style="width: 300px"><label>点击参加活动： </label><a href="#" onclick="actReg()" class="btn btn-2 ">报名</a></div>
								</c:if>
								<a onclick="xixi()">haah</a>
							</div>
						</div>
						<div class="clear"></div>
					</div>	
